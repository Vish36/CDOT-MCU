...
<p>\
Служба CDOT-MCU запущена і приймає підключення.\
</p>\
<p>\
Конференція, що створена підключенням першого терміналу, спочатку працює у некерованому режимі, при цьому всі учасники конференції бачать однакову картинку.\
 У некерованому режимі CDOT-MCU автоматично змінює розкладку екрану залежно від кількості підключених користувачів, у порядку, визначеному у файлі layouts.conf.\
...
window.l_server_id                                 = "Ідентифікатор сервера CDOT-MCU";
