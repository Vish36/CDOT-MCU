...
<p>\
Service CDOT-MCU is running and accepting connections.\
</p>\
<p>\
Conference started by connection from some terminal will work in unmanaged mode. All members will see the same picture. In unmanaged mode CDOT-MCU automatically change layout depending on number of conference members, in order  from file "layouts.conf". After connecting 100 members other connecting members will not be visible, but will see others.<br />\
...
window.l_server_id                                 = "CDOT-MCU Softswitch Server IP";
